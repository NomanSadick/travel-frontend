...
const SortDropdownn = ({ sortOrder, setSortOrder }: Props) => {
    ...
    <div className="flex flex-col gap-4 mb-6 relative">
      ...
      <div className="relative">
        <select
          ...
          className="w-full border rounded px-4 py-2 bg-sky-50 appearance-none text-gray-700 "
        >
